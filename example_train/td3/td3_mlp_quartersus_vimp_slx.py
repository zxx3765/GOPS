...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_id", type=str, default="simu_quarter_sus_vimp", help="id of environment")
    ...
    parser.add_argument("--act_scaling", type=list, default=[1,1000,10000])
    parser.add_argument("--rew_scaling", type=float, default=1)
    parser.add_argument("--act_max", type=float, default=100)
    ...
    if value_func_type == "MLP":
        parser.add_argument("--value_hidden_sizes", type=list, default=[64,128,128, 64])
        parser.add_argument(
