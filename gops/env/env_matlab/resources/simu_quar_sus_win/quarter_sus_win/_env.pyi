...
class ActionRepeatMode:
    ...
    def value(self) -> int:
        ...
class EnvSpec:
    def __init__(self, id: str, reward_threshold: typing.SupportsFloat | None = None, max_episode_steps: typing.SupportsInt | None = None, indexing_mode: IndexingMode = IndexingMode.IndexingMode.PRESERVE_EMPTY, nondeterministic: bool = False, auto_reset: bool = False, strict_reset: bool = True, need_render: bool = False, action_repeat: typing.SupportsInt = 0, action_repeat_mode: ActionRepeatMode = ActionRepeatMode.ActionRepeatMode.SUM_BREAK, **kwargs) -> None:
        ...
    def __repr__(self) -> str:
        ...
    @property
